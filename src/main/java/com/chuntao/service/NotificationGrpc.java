...
public final class NotificationGrpc {
  ...
  public static io.grpc.MethodDescriptor<com.chuntao.service.VentilationResponse,
    ...
    if ((getReceiveNotificationsMethod = NotificationGrpc.getReceiveNotificationsMethod) == null) {
      synchronized (NotificationGrpc.class) {
        if ((getReceiveNotificationsMethod = NotificationGrpc.getReceiveNotificationsMethod) == null) {
          NotificationGrpc.getReceiveNotificationsMethod = getReceiveNotificationsMethod =
              ...
              .setSchemaDescriptor(new NotificationMethodDescriptorSupplier("ReceiveNotifications"))
              .build();
        }
      }
    }
  ...
  private static final int METHODID_RECEIVE_NOTIFICATIONS = 0;
